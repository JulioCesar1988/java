...
public class PantallaPrincipal extends JFrame {
    ...
    mntmCargarListaCon.addActionListener(new ActionListener() {
    	public void actionPerformed(ActionEvent arg0) {
    		...
    		// Obra 
    		// Paquete (descripcion)  El número de paquete me lo genera el controlador cuando lo doy de alta .
    		// Edificio.
    		// fecha de temrinacion + fechas de despacho 
    		// Sistema de diseño  
    		// PIEZAS : Cantidad , Elemento , Correlatividad , Descripcion , Descripcion extra , Pintura ,Color ,largo ,Peso Unitario  ,Codigo , Área ,Ubicación
        	// SUBPIEZAs : Cantidad posicion correlatividad , Descripcion ,Material  peso , largo/area , Peso unidad , peso total , observaciones. 
